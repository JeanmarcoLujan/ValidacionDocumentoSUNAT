    ...
    public class RatesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Rates != null ? 
                          ...
                          Problem("Entity set 'AppDBContext.Rates'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DateRate,Purchase,Sale")] Rate rate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateRate,Purchase,Sale")] Rate rate)
        {
            if (id != rate.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDBContext.Rates'  is null.");
            }
            var rate = await _context.Rates.FindAsync(id);
            if (rate != null)
            {
